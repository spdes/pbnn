...
# Parse arguments
parser = argparse.ArgumentParser(description='Synthetic regression using MAP-SWAG.')
...
print('Running regression with SWAG.')
...
if args.adam:
    filename = f'./results/regression/swag_adam_{args.id}'
else:
    filename = f'./results/regression/swag_{args.id}'
np.savez(filename,
