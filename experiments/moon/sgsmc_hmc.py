...
# Parse arguments
parser = argparse.ArgumentParser(description='Synthetic classification using SG-SMC.')
...
print('Running moon with SGSMC-HMC.')
...
np.savez(f'./results/moon/sgsmc_hmc_{args.id}',
