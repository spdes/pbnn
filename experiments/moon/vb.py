...
# Parse arguments
parser = argparse.ArgumentParser(description='Synthetic classification using variational Bayes.')
...
for i in range(args.max_epochs):
    ...
    for j in range(int(data_size / batch_size)):
        ...
        if nlpd < opt_nlpd:
            ...
            np.savez(f'./results/moon/vb_{args.id}',
